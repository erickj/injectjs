...
goog.exportSymbol('inject.$bind', inject.$bind);
goog.exportSymbol('inject.$into', inject.$into);
goog.exportSymbol('inject.$locate', inject.$locate);
goog.exportSymbol('inject.Binding', inject.Binding);
goog.exportSymbol('inject.Binding.prototype', inject.Binding.prototype);
goog.exportSymbol('inject.Binding.prototype.toInstance',
    inject.Binding.prototype.toInstance);
goog.exportSymbol('inject.Binding.prototype.asConstructor',
    inject.Binding.prototype.asConstructor);
